/*
  # Add subjects table and update existing tables
...
INSERT INTO subjects (id, name, code, description, color, is_active) VALUES
  ('SUB001', 'Toán học', 'MATH', 'Môn Toán học cơ bản và nâng cao', '#EF4444', true),
  ('SUB002', 'Ngữ văn', 'LANG', 'Môn Ngữ văn và văn học', '#10B981', true),
  ('SUB003', 'Tiếng Anh', 'ENG', 'Môn Tiếng Anh giao tiếp và ngữ pháp', '#3B82F6', true),
  ('SUB004', 'Vật lý', 'PHY', 'Môn Vật lý cơ bản', '#8B5CF6', true),
  ('SUB005', 'Hóa học', 'CHEM', 'Môn Hóa học cơ bản', '#F59E0B', true),
